...
//
//	mockgen.exe -source=C:/Users/Dinesh/go/src/BillingGo/repository/bill-repo.go -destination=C:/Users/Dinesh/go/src/BillingGo/mocks/repositoryMocks.go -package=mocks
//
...
func (m *MockBillRespository) DeleteCutomer(id string) error {
	m.ctrl.T.Helper()
