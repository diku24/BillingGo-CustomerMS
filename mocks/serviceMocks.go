...
//
//	mockgen.exe -source=C:/Users/Dinesh/go/src/BillingGo/services/service.go -destination=C:/Users/Dinesh/go/src/BillingGo/mocks/serviceMocks.go -package=mocks
//
...
func (m *MockBillService) Delete(id string) error {
	m.ctrl.T.Helper()
